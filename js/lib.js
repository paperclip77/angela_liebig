...
!function(a) {
    ...
    var k, s, w, d = "2.8.3", e = {}, f = !0, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, m = ({}.toString, 
    {
        svg: "http://www.w3.org/2000/svg"
    }), n = {}, q = [], r = q.slice, t = function(a, c, d, e) {
    ...
    w = z(v, "undefined") || z(v.call, "undefined") ? function(a, b) {
    ...
    return e.addTest = function(a, b) {
        if ("object" == typeof a) for (var d in a) w(a, d) && e.addTest(d, a[d]); else {
        ...
        a.html5 = s, r(b);
    }(this, b), e._version = d, e.mq = u, e.testStyles = t, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + q.join(" ") : ""), 
    e;
